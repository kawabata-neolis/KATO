...
namespace KATO.Form.M1150_ShohinTankaIkkatsuUpdate
{
    ...
    public partial class M1150_ShohinTankaIkkatsuUpdate : BaseForm
    {
        ...
        private void SetUpGrid()
        {
            ...
            setColumn(chubunruiName, DataGridViewContentAlignment.MiddleLeft, DataGridViewContentAlignment.MiddleCenter, null, 100);
            setColumn(makerName, DataGridViewContentAlignment.MiddleLeft, DataGridViewContentAlignment.MiddleCenter, null, 100);
        ...
        ///<summary>
        ///ShohinTankaIkkatsuUpdateTxt_KeyDown
        ///キー入力判定（テキストボックス）
        ///</summary>
        private void ShohinTankaIkkatsuUpdateTxt_KeyDown(object sender, KeyEventArgs e)
        {
            //キー入力情報によって動作を変える
            switch (e.KeyCode)
            {
