...
namespace KATO.Form.M1120_Tanaban
{
    ...
    public partial class M1120_Tanaban : BaseForm
    {
        ...
        ///     F10：Excel出力
        ///</summary>
        private void excelTanaban()
        {
            //SQL実行時に取り出したデータを入れる用
            DataTable dtSetCd_B = new DataTable();

            //ビジネス層のインスタンス生成
            M1120_Tanaban_B daibunB = new M1120_Tanaban_B();
            try
            {
                ...
                // ファイル名の指定
                sfd.FileName = "棚番マスタ_" + DateTime.Now.ToString("yyyy_MM_dd_HH_mm_ss") + ".xlsx";
                // デフォルトパス取得（デスクトップ）
                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    // Excel作成処理
                    cpdf.DtToXls(dtChkList, "棚番マスタリスト", outFile, 3, 1, header);
