...
namespace KATO.Form.C0482_SiireSuiiHyo
{
    public partial class C0482_SiireSuiiHyoLevel3 : System.Windows.Forms.Form
    {
        private static readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        private List<string> lstString; // 仕入推移表レベル２から値を受け取るリスト
        ...
        /// <summary>
        /// C0492_SiireSuiiHyoLevel3
        /// 仕入推移表レベル３
        /// </summary>
        /// <param name="c"></param>
        /// <param name="argumentValues">仕入推移表レベル２から送られたリスト</param>
        public C0482_SiireSuiiHyoLevel3(Control c, List<string> argumentValues)
        {
            // SiireSuiiHyoLevel2から引数を取得
        ...
        private void C0482_SiireSuiiHyoLevel3_Load(object sender, EventArgs e)
        {
            this.Show();
            this._Title = "分類別仕入推移表レベル３";
        ...
        /// <summary>
        /// C0482_SiireSuiiHyoLevel3_KeyDown
        /// キー入力判定
        /// </summary>
        private void C0482_SiireSuiiHyoLevel3_KeyDown(object sender, KeyEventArgs e)
        {
            // キー入力情報によって動作を変える
            switch (e.KeyCode)
            {
        ...
        private void setSiireSuiiHyo()
        {
            ...
            // ビジネス層のインスタンス生成
            C0482_SiireSuiiHyoLevel3_B siiresuiihyolevel3B = new C0482_SiireSuiiHyoLevel3_B();
            try
            {
                // データの存在確認を検索する情報を入れる
                /*[0]開始期間*/
                ...
                dtSetView = siiresuiihyolevel3B.setViewGrid(lstSiireSuiiLoad);
