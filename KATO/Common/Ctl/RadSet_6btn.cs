...
{
    public partial class RadSet_6btn : UserControl
    {
        ...
        private int positionRadbtn6_X = 650;
        public int PositionRadbtn6_X
        {
            get
            {
                return positionRadbtn6_X;
            }
            set
            {
                positionRadbtn6_X = value;
                radbtn5.Left = positionRadbtn6_X;
            }
        }

        private int positionRadbtn6_Y = 0;
        public int PositionRadbtn6_Y
        {
            get
            {
                return positionRadbtn6_Y;
            }
            set
            {
                positionRadbtn6_Y = value;
                radbtn5.Top = positionRadbtn6_Y;
            }
        }
