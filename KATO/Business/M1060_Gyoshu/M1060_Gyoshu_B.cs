...
namespace KATO.Business.M1060_Gyoshu
{
    ...
    class M1060_Gyoshu_B
    {
        ...
        public DataTable getPrintData()
        {
            ...
            //SQLファイルのパスとファイル名を追加
            lstSQL.Add("M1060_Gyoshu");
            lstSQL.Add("Gyoshu_PrintData_SELECT");
            ...
            try
            {
                ...
                foreach (DataRow drSiireCheak in dtChkList.Rows)
                {
                    ...
                    if (rowCnt == 1)
                    {
                        ...
                        // ヘッダー部の指定（番号）
                        headersheet.PageSetup.Header.Left.AddText("（№106）");
