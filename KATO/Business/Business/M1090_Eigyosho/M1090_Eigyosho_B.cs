...
namespace KATO.Business.M1090_Eigyosho
{
    ...
    ///カラム論理名
    ///</summary>
    class M1090_Eigyosho_B
    {
        ///<summary>
        ///addEigyosho
        ///テキストボックス内のデータをDBに登録
        ///</summary>
        public void addEigyosho(List<string> lstString)
        {
            //接続用クラスのインスタンス作成
        ...
        ///</summary>
        public void delEighosho(List<string> lstString)
        {
            //接続用クラスのインスタンス作成
            DBConnective dbconnective = new DBConnective();
        ...
        public DataTable getPrintData()
        {
            ...
            //SQLファイルのパスとファイル名を追加
            lstSQL.Add("M1090_Eigyosho");
            lstSQL.Add("Eigyosho_PrintData_SELECT");
            ...
            try
            {
                ...
                foreach (DataRow drSiireCheak in dtChkList.Rows)
                {
                    ...
                    if (rowCnt == 1)
                    {
                        ...
                        headersheet.Cell("B3").Value = "営業所名";
                        ...
                        // ヘッダー部の指定（番号）
                        headersheet.PageSetup.Header.Left.AddText("（№109）");
                    ...
                    for (int colCnt = 1; colCnt <= maxColCnt; colCnt++)
                    {
                        ...
                        if (colCnt == 1)
                        {
                            ...
                            kingakuCell.Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center;
