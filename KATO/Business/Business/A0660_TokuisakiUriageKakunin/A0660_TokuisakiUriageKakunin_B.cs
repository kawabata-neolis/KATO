...
namespace KATO.Business.A0660_TokuisakiUriageKakunin
{
    /// <summary>
    ...
    class A0660_TokuisakiUriageKakunin_B
    {
        /// <summary>
        ...
        public DataTable getSiireData(string[] arrSearch, string[] arrOrder, string[] arrDisplay)
        {
            ...
            try
            {
                ...
                {
                    // 未検収のみ表示の場合
                    andSql += " AND dbo.f_get検収フラグ(a.伝票番号,b.行番号) IS NULL ";
                }
                else if (arrDisplay[2].Equals("TRUE"))
                {
                    // 検収済のみ表示の場合
                    andSql += " AND dbo.f_get検収フラグ(a.伝票番号,b.行番号) = '済' ";
                }
                ...
                listSqlPath.Add("A0660_TokuisakiUriageKakunin");
                listSqlPath.Add("A0660_TokuisakiUriageKakunin_SELECT");
        ...
        /// <summary>
        ///     検収済売上明細テーブル更新(検収済売上明細更新_PROC実行)
        /// </summary>
        /// <param name="dt">
