...
namespace KATO.Business.H0210_MitsumoriInput
{
    class H0210_MitsumoriInput_B
    {
        ...
        public DataTable getMitsumoriDetail(string strNum)
        {
            ...
            strSQL += "       粗利３,";
            strSQL += "       粗利率３,";
            strSQL += "       null as 仕入先コード４,";
            strSQL += "       null as 仕入先名４,";
            strSQL += "       null as 仕入単価４,";
            strSQL += "       null as 仕入金額４,";
            strSQL += "       null as 粗利４,";
            strSQL += "       null as 粗利率４,";
            strSQL += "       null as 仕入先コード５,";
            strSQL += "       null as 仕入先名５,";
            strSQL += "       null as 仕入単価５,";
            strSQL += "       null as 仕入金額５,";
            strSQL += "       null as 粗利５,";
            strSQL += "       null as 粗利率５,";
            strSQL += "       null as 仕入先コード６,";
            strSQL += "       null as 仕入先名６,";
            strSQL += "       null as 仕入単価６,";
            strSQL += "       null as 仕入金額６,";
            strSQL += "       null as 粗利６,";
            strSQL += "       null as 粗利率６,";
            strSQL += "       null as 加工仕入先コード１,";
            strSQL += "       null as 加工仕入先名１,";
            strSQL += "       null as 加工仕入単価１,";
            strSQL += "       null as 加工仕入金額１,";
            strSQL += "       null as 加工粗利１,";
            strSQL += "       null as 加工粗利率１,";
            strSQL += "       null as 加工仕入先コード２,";
            strSQL += "       null as 加工仕入先名２,";
            strSQL += "       null as 加工仕入単価２,";
            strSQL += "       null as 加工仕入金額２,";
            strSQL += "       null as 加工粗利２,";
            strSQL += "       null as 加工粗利率２,";
            strSQL += "       null as 加工仕入先コード３,";
            strSQL += "       null as 加工仕入先名３,";
            strSQL += "       null as 加工仕入単価３,";
            strSQL += "       null as 加工仕入金額３,";
            strSQL += "       null as 加工粗利３,";
            strSQL += "       null as 加工粗利率３,";
            strSQL += "       null as 加工仕入先コード４,";
            strSQL += "       null as 加工仕入先名４,";
            strSQL += "       null as 加工仕入単価４,";
            strSQL += "       null as 加工仕入金額４,";
            strSQL += "       null as 加工粗利４,";
            strSQL += "       null as 加工粗利率４,";
            strSQL += "       null as 加工仕入先コード５,";
            strSQL += "       null as 加工仕入先名５,";
            strSQL += "       null as 加工仕入単価５,";
            strSQL += "       null as 加工仕入金額５,";
            strSQL += "       null as 加工粗利５,";
            strSQL += "       null as 加工粗利率５,";
            strSQL += "       null as 加工仕入先コード６,";
            strSQL += "       null as 加工仕入先名６,";
            strSQL += "       null as 加工仕入単価６,";
            strSQL += "       null as 加工仕入金額６,";
            strSQL += "       null as 加工粗利６,";
            strSQL += "       null as 加工粗利率６,";
            strSQL += "       a.商品コード,";
            strSQL += "       a.大分類コード,";
            strSQL += "       a.中分類コード,";
            strSQL += "       a.メーカーコード,";
