...
namespace KATO.Business.C0530_UriageArariSuiihyoPrint
{
    ...
    class C0530_UriageArariSuiihyoPrint_B
    {
                    ...
                    foreach (DataRow drSuiihyo in dtChkList.Rows)
                    {
                        ...
                        if (rowCnt == 1)
                        {
                            ...
                            else
                            {
                                ...
                                // ヘッダーシートからコピー
                                int worksheetCnt = workbook.Worksheets.Count;
                                headersheet.CopyTo("Page" + worksheetCnt.ToString());
                                currentsheet = workbook.Worksheet(worksheetCnt + 1);
                            }
                        ...
                        if (xlsRowCnt == 37)
                        {
                            ...
                            if (pageCnt <= maxPage)
                            {
                                ...
                                sheetCopy(ref workbook, ref headersheet, ref currentsheet, workbook.Worksheets.Count);
                            }
                        }
        ...
        /// </summary>
        private void sheetCopy(ref XLWorkbook workbook, ref IXLWorksheet headersheet, ref IXLWorksheet currentsheet, int pageCnt)
        {
            // ヘッダーシートからコピー
